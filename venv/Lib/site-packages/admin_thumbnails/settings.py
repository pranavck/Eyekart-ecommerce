...
""" Sets the default label used for the field and column created for each
    thumbnail
"""
ADMIN_THUMBNAIL_DEFAULT_LABEL = getattr(
    settings, "ADMIN_THUMBNAIL_DEFAULT_LABEL", "Preview"
)
...
"""
ADMIN_THUMBNAIL_FIELD_SUFFIX = getattr(
    settings, "ADMIN_THUMBNAIL_FIELD_SUFFIX", "_thumbnail"
)
...
"""
ADMIN_THUMBNAIL_THUMBNAIL_ALIAS = getattr(
    settings, "ADMIN_THUMBNAIL_THUMBNAIL_ALIAS", "admin_thumbnail"
)

""" The following CSS styles will be applied to thumbnails when displayed in
    the admin
"""
ADMIN_THUMBNAIL_STYLE = getattr(
    settings,
...
""" If the `background` option is used, the following additional CSS styles
    will be applied
"""
ADMIN_THUMBNAIL_BACKGROUND_STYLE = getattr(
    settings,
